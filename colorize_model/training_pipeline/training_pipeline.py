...
from constants import wandb_project_name, experiments_path
...
def pipeline(hyperparameters, models_metadata, device="cpu"):
    ...
    with wandb.init(project=wandb_project_name, config=hyperparameters, job_type="training",
        ...
        model_artifact = wandb.Artifact(
            "generator_experiments", type="model",
        ...
        model_artifact.add_file(path_to_save, name="experiments/generator.onnx")
